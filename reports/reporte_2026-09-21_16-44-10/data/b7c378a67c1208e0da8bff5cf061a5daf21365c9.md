...
Call log:
  - waiting for getByRole('button', { name: 'Cargar Identificación oficial' })
    - locator resolved to <input type="file" class="sr-only" accept=".pdf,.jpg,.jpeg,.png" aria-label="Cargar Identificación oficial"/>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <svg class="" width="15" fill="none" height="15" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">…</svg> intercepts pointer events
  ...
  2 × retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <div class="app-header__bar">…</div> from <header class="app-header">…</header> subtree intercepts pointer events
